...
#define T0A _EQ(                           '9'                       )
#define T0B _EQ(                           '0'                       )
#define T0C _EQ(                           CAPITAL                   ) // Enthium: Capslock on -
#define T0D _EQ(                           RMENU                     ) // Enthium: RightAlt on =
#define T0E _EQ(                           BACK                      )
#define T0F _EQ(                           TAB                       )
#define T10 _EQ(                           'Q'                       )
#define T11 _EQ(                           'W'                       )
...
#define T39 _EQ(                           ' '                       )
#define T3A _EQ(                           'B'                       ) // Enthium: B on Capslock
#define T3B _EQ(                           F1                        )
#define T3C _EQ(                           F2                        )
#define T3D _EQ(                           F3                        )
#define T3E _EQ(                           F4                        )
...
#define X38 _EQ(                           'R'                       ) // Enthium: R on RightAlt
